...
public class MemberController {
    ...
    @PostMapping("/signup")
    public ResponseEntity<CommonResponseDto> signup(MemberRequestDto memberRequestDto){
        try{
            memberService.signup(memberRequestDto);
        } catch(IllegalArgumentException e){
            return ResponseEntity.badRequest().body(new CommonResponseDto("중복된 이메일 입니다.",
