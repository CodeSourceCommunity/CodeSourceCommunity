...
public class EmailService {
    ...
    public String joinEmail(String email) {
        ...
        Email emailAuth = new Email(email, String.valueOf(authNumber));
    ...
    public boolean CheckAuthNum(String email, String authNum) {
        Email emailAuth = emailRepository.findByEmail(email);
        return emailAuth.getAuthNumber().equals(authNum);
    }
